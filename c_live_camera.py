...
class LiveCameraScreen(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # Tombol "Selesai" menggunakan gambar
        button_image_1 = PhotoImage(file=relative_to_assets("c-button-1.png"))
        button_1 = Button(
            self,
        ...
        button_1.place(x=1654, y=841, width=180, height=100)  # Diubah ukuran dan posisinya
    ...
    def finish_capture(self):
        ...
        if self.is_frozen and self.cap:
            ret, frame = self.cap.read()
            if ret:
                folder_name = self.controller.patient_folder  # Folder dari DataPasienScreen
                ...
                # Crop the frame with dynamic coordinates
                ...
                # Save the black and white cropped image
                cropped_bw_path = self.save_black_and_white_image(cropped_frame, folder_name)

                # Perform YOLOv8 segmentation on the cropped BW image
                if cropped_bw_path:
